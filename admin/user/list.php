...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">List Pengguna Sistem</h3>
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Bikin Baru</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td ><p class="m-0"><?php echo ($row['type'] == 1 )? "Adminstrator" : "Customer" ?></p></td>
							<td align="center">
